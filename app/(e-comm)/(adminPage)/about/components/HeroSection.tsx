        ...
        {imageUrl && imageUrl.trim() !== '' && (
            <>
                ...
                <div className="mt-6 text-center px-4">
                    <h1 className="text-4xl md:text-5xl font-extrabold mb-3 font-arabic text-foreground">
                        {title}
                    </h1>
                    <p className="text-lg md:text-2xl font-medium font-arabic max-w-3xl mx-auto text-muted-foreground">
                        {subtitle}
                    </p>
                </div>
            </>
