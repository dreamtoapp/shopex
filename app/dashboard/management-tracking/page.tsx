                ...
                <Card className="shadow-lg border-l-4 border-l-feature-commerce card-hover-effect">
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            ...
                            {[
                                { id: '682901b03eb14d5595ae2ad5', orderNumber: 'ORD-2024-001', status: 'active', customer: 'سارة أحمد' },
                                { id: '682901b03eb14d5595ae2ad6', orderNumber: 'ORD-2024-002', status: 'waiting', customer: 'فاطمة محمد' },
                                { id: '682901b03eb14d5595ae2ad7', orderNumber: 'ORD-2024-003', status: 'active', customer: 'عبدالله أحمد' },
                            ].map((order) => (
