...
export default async function Icon() {
  try {
    ...
    if (logoUrl && logoUrl.trim() !== '') {
      try {
        ...
        console.warn('Failed to fetch company logo for favicon, using fallback:', fetchError);
        // Fall through to fallback design
      }
    }
  } catch (error) {
    console.warn('Failed to get company info for favicon, using fallback:', error);
    // Fall through to fallback design
  }
  ...
  try {
    ...
    console.warn('Failed to read fallback logo for favicon:', fallbackError);
