...
import {
    ...
    Building2, MapPin, Cog, Palette, RotateCcw, Undo, File, Expand, Eye, Lock, Key, Focus
} from 'lucide-react';
...
const iconMap = {
    ...
    Building2, MapPin, Cog, Palette, RotateCcw, Undo, File, Expand, Eye, Trash, Lock, Key, Focus
};
